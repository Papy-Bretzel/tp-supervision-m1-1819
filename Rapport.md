...
### Analyse de risque et choix des métriques
...
D'autre part, nous avons plus haut exprimé l'importance de l'intégrité du code le Radio Bretzel, et donc de la sensibilité de son processus de sauvegarde. Ce dernier est réalisé via un playbook Ansible joué quotidiennement dans une tâche `cron`. Ainsi, il peut être intéressant de surveiller le code de sortie du job et l'output du playbook.
...
### Définition des seuils et actions
...
Dans le cas de Radio Bretzel, peu d'aspects de l'administration de la plateforme sont automatisés. Ainsi, les seules actions que nous choisirons de mettre en place sont des alertes par mail, renouvelées quotidiennement si non résolues.
...
#### Surveillance du processus de sauvegarde
